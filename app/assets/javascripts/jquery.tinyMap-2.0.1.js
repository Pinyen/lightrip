 ...
 *
 * tinyMap 2.0.1 - 自訂個人 Google Map 的 jQuery 擴充套件
                    ...
                    if ('string' === typeof options.center) {
                        ...
                        geocoder.geocode({'address': options.center}, function (results, status) {
                            ...
                            try {
                                ...
                                var msg = ('undefined' !== typeof err.message ? err.message : err.description).toString();
                                jQuery(container).html(msg.replace(/</g, '&lt;').replace(/>/g, '&gt;'));
                            }
